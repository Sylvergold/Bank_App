...
exports.transfer = async (req, res) => {
    try {
        ...
        const comparetransacPin = bcryptjs.compareSync(transacPin, checkUser.transactionPin);
    ...
    const depositToSender = await new TransactionHistionModel({
    ...
    const depositToReceiver = await new TransactionHistoryModel({
